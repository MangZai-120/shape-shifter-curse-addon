...
// SP使魔形态红色变种 (Red)
public class Form_FamiliarFoxRed extends PlayerFormBase {
    ...
    public void Anim_registerAnims() {
        ...
        anim_ride = new AnimationHolder(new Identifier(MOD_ID, "familiar_fox_3_riding"), true); // Keep original animation
